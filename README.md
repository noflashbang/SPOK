...
•	SPC_GetFilteredBootLog: Gets the filtered boot log.
...
•	SPS_AIKPlatformAttest_Decode: Decodes an AIK platform attestation.
...
###AIK TPM Attestation
•	SPS_AIKTpmAttest_Decode: Decodes an AIK TPM attestation.
...
###AIK Key Attestation
•	SPS_AIKKeyAttest_Decode: Decodes an AIK key attestation.
